...
//     setShort(null);
//     try {
//       const resp = await fetch("https://retainsure-astv.onrender.com/api/shorten", {
//         method: "POST",
...
//     setStats(null);
//     try {
//       const resp = await fetch(`https://retainsure-astv.onrender.com/api/stats/${inputCode.trim()}`);
//       let data;
//       const contentType = resp.headers.get("content-type");
//       if (contentType && contentType.includes("application/json")) {
//         data = await resp.json();
...
//         throw new Error("Server did not return JSON");
//       }
//       if (!resp.ok) throw new Error("Stats not found for code");
//       setStats(data);
//     } catch {
//       setError("No stats found for this short code");
//     } finally {
